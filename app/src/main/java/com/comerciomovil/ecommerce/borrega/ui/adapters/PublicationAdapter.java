package com.comerciomovil.ecommerce.borrega.ui.adapters;
...
import com.comerciomovil.ecommerce.borrega.model.PublicationCardViewModel;
...
import com.comerciomovil.ecommerce.borrega.ui.activities.DetailPublicationActivity;
...
import com.comerciomovil.ecommerce.borrega.ui.fragments.ProductsFragment;
import com.comerciomovil.ecommerce.borrega.ui.interfaces.OnLoadMoreListener;
...
public class PublicationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof PublicationAdapter.ViewHolder) {
            ...
            if (publications.get(position).getStock().equals("0")) {
