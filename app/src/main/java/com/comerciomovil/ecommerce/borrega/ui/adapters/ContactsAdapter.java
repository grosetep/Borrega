...
import com.comerciomovil.ecommerce.borrega.model.Contact;
import com.comerciomovil.ecommerce.borrega.tools.Constants;
import com.comerciomovil.ecommerce.borrega.ui.activities.ContactActivity;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Contact model) {
            ...
            if (model.isSelected()){
                ...
                Log.d(TAG, "-------nothing");image.setColorFilter(ContextCompat.getColor(activity, R.color.gray));}
        }
    }
    @Override
