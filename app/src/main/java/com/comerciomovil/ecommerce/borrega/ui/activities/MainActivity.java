...
import com.comerciomovil.ecommerce.borrega.items.ConfigItem;
import com.comerciomovil.ecommerce.borrega.items.UserItem;
import com.comerciomovil.ecommerce.borrega.tools.ApplicationPreferences;
import com.comerciomovil.ecommerce.borrega.tools.Constants;
import com.comerciomovil.ecommerce.borrega.tools.FireBaseOperations;
...
import com.comerciomovil.ecommerce.borrega.ui.fragments.OfferFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    private void setupViewPager(ViewPager viewPager) {
       ...
       // adapter.addFragment(MenuFragment.createInstance("init"),"MENU");
        adapter.addFragment(OfferFragment.createInstance(getParametersProductsSection()),"OFERTAS");
