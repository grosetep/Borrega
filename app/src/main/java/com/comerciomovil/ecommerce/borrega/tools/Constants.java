package com.comerciomovil.ecommerce.borrega.tools;
...
public class Constants {
    ...
    public static final String SUBDOMAIN = "/todoborrega/services/services.php/";
     ...
     */
    /*Publications*/
    public static final String GET_PRODUCTS = HTTPS + IP + PUERTO_HOST + "/todoborrega/services/getProducts.php";
    /* Upload images*/
    public static final String UPLOAD_IMAGE = HTTP + IP + PUERTO_HOST + "/todoborrega/services/uploadImage.php";
    ...
    public static final String PACKAGE_NAME =
            "com.comerciomovil.ecommerce.borrega";
    ...
    public static final String merchant_key = "merchant_04012018_borre";
    public static final String app_label = "todo_borrega";
